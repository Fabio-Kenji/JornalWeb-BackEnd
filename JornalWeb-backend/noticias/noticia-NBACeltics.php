...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>NBA: Celtics atropelam os Cavaliers no jogo 1 das semifinais dos playoffs</h1>

            <h6>No TD Garden, Boston venceu os visitantes por 120 a 95 e abriu 1 a 0 na série dos playoffs da Conferência Leste</h6>

            <img src="../assets/image/celtics-basquete.jpeg" alt="">
