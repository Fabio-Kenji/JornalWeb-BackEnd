...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Tensão no Oriente Médio</h1>

            <h6>Israel aumentou em 5% a compra de armas desde 2019; Irã fez maior compra de caças em 20 anos.</h6>

            <img src="../assets/image/israel-palestinians-syria-iran.jpeg" alt="">
