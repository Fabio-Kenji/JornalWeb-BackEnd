...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Davi é recebido com festa por multidão no aeroporto de Salvador após vencer BBB 24</h1>

            <h6>Baiano retornou para Salvador neste sábado (20), após finalizar os compromissos de trabalho no Rio de Janeiro</h6>

            <img src="../assets/image/davi-mae-aeroporto-reproducaotvbahia.jpeg" alt="">
