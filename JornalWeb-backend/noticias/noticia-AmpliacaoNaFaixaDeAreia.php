...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Ampliação da faixa de areia</h1>

            <h6>Cidades alargaram ao menos 38 km de praias nos últimos anos; entenda por que municípios apostam nas engordas.</h6>

            <img src="../assets/image/degrau-areia-balneario-camboriu.jpeg" alt="">
