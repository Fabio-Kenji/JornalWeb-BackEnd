...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Em duelo pegado, Palmeiras e Flamengo empatam no Brasileirão</h1>

            <h6>Ao todo, onze cartões amarelos foram distribuídos; seis para o Verdão e cinco para o Rubro-Negro</h6>

            <img src="../assets/image/pal-fla.jpg" alt="">
