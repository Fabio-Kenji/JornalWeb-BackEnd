...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Putin assume quinto mandato como presidente da Rússia e promete 'vitória' em apelo patriótico</h1>

            <h6>Oposição russa no exílio marca data com críticas ao mandatário, acusado pelo Ocidente de minar a democracia no país.</h6>

            <img src="../assets/image/Putin.jpeg" alt="">
