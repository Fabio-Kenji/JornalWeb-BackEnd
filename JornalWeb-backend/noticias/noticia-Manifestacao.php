...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Bolsonaro reúne apoiadores em manifestação no Rio</h1>

            <h6>Ato acontece em Copacabana, na Zona Sul da cidade.</h6>

            <img src="../assets/image/manifestacao.jpeg" alt="">
