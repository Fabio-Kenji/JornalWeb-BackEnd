...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Tragédia no RS: municípios calculam 100 mil casas destruídas ou danificadas pela chuva</h1>

            <h6>Dados foram informados pelas prefeituras à Defesa Civil e valem até a tarde de 7 de maio, segundo Confederação Nacional dos Municípios. Prejuízo estimado é de R$ 4,6 bilhões.</h6>

            <img src="../assets/image/Inundacao-RS.jpeg" alt="">
