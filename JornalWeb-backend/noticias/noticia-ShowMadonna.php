...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Programação da Globo hoje: terça tem bastidores do show da Madonna no Profissão Repórter</h1>

            <h6>Confira a grade de 7 de maio e os horários dos programas da TV Globo</h6>

            <img src="../assets/image/Madonna.jpeg" alt="">
