...
<header>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Chuva de meteoros é registrada no interior de SP; fotos</h1>

            <h6>Estudantes de Itapetininga (SP) captaram o fenômeno no domingo (5); astrônomo amador de Nhandeara (SP) também fez o registro na madrugada de segunda (6). Chuva de meteoros Eta Aquáridas é formada por pedaços do cometa Halley e pode ser vista a olho nu.</h6>

            <img src="../assets/image/Chuva-de-Meteoro.jpeg" alt="">
