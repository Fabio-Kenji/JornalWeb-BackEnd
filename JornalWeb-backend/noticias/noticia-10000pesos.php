...
<header>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Argentina coloca em circulação nova nota de 10 mil pesos</h1>

            <h6>Até então, a cédula de maior valor disponível no país era a de 2 mil pesos. Lançamento ocorre em meio a uma inflação de 287,9%.</h6>

            <img src="../assets/image/10000-pesos.jpeg" alt="">
