...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Como hacker adolescente se transformou em um dos criminosos mais procurados da Europa</h1>

            <h6>Kivimäki foi responsável por um dos ataques mais chocantes da história da Finlândia — ele chantageou 33 mil pessoas, ameaçando vazar as anotações das suas sessões de terapia online.</h6>

            <img src="../assets/image/Hacker-preso.jpeg" alt="">
