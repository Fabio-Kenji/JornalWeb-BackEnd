...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Empresário envolvido em esquema de agiotagem do PCC é preso a caminho do RS para ajudar vítimas da enchente</h1>

            <h6>Segundo o Ministério Público, Sedemir Fagundes integra um grupo que movimentou mais de R$ 20 milhões somente no ano passado. Os criminosos emprestavam dinheiro com juros que chegavam a 300% por mês, além de praticarem extorsão e ameaça contra os devedores.</h6>

            <img src="../assets/image/Empresario-agiota.jpeg" alt="">
