...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Sucesso nas areias</h1>

            <h6>'Olha o mate!': conheça alguns dos quase 300 mateiros de galão das praias do Rio regulamentados.</h6>

            <img src="../assets/image/11mate1.jpeg" alt="">
