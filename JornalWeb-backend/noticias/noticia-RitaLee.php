...
<body>
    ...
    <main>
        ...
        <article class="noticia">
            ...
            <h1>Veja as dez músicas de Rita Lee mais tocadas desde a morte dela, há um ano</h1>

            <h6>De acordo com ECAD, 'Mania de Você', 'Agora Só Falta Você' e 'Ovelha Negra' lideram ranking. Escritório de Arrecadação também divulgou composições da Rainha do Rock mais regravadas</h6>

            <img src="../assets/image/rita-lee-divulgacao.jpeg" alt="">
